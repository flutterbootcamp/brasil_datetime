...
void main() {
  ...
  group('DateTime(2024, 1, 5, 8, 9, 4)', () {
    ...
    test('dia da semana abreviado',
        () => expect(data2.diaSemanaAbrev(), 'sex.'));
    ...
    test('dia da semana e mês',
        () => expect(data2.diaSemanaEMes(), 'sex., 05/01'));
    test('dia e mês por extenso',
        () => expect(data2.diaMesExt(), '5 de janeiro'));
    test('dia da semana e mês por extenso',
    ...
    test('mês e ano abreviado',
        () => expect(data2.mesAnoAbrev(), 'jan. de 2024'));
    ...
    test('mês e ano por extenso',
        () => expect(data2.mesAnoExt(), 'janeiro de 2024'));
    ...
    test('trimestre e ano por extenso',
